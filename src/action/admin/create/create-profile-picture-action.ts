...
export const createProfilePictureAction = async (
    ...
    try {
        ...
        if (!result.success && !res.ok) {
            return {
                success: false,
                message: "Erro ao criar foto de perfil. Tente novamente mais tarde.",
            };
        }
        ...
        return {
            ...
            message:
                err instanceof Error
                    ? err.message
                    : "Erro ao criar foto de perfil. Tente novamente mais tarde.",
        };
    }
};
